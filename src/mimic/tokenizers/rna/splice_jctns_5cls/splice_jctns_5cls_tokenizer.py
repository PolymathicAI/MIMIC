...
JUNCTION_VOCAB= ["0", "1", "2", "3", "4"]
# 0: No junction
# 1: Acceptor junction
# 2: Donor junction
# 3: Beginning of first exon
# 4: End of last exon

splice_jctns_5cls_tokenizer = CharLevelTokenizer(vocab_list=JUNCTION_VOCAB, version=_version)
...
if __name__ == "__main__":
    test_tokenizer(tokenizer=splice_jctns_5cls_tokenizer)
