...
path = paths.get_path(data_type="data", stage="downloads", name="phylop", version="mm39-35way")
url = "rsync://hgdownload.cse.ucsc.edu/goldenPath/mm39/phyloP35way/"
...
# %%
logger.info(f"Downloading PhyloP 35-way mm39 to {path}...")
logger.info("The data is about 10GB and takes about 30  mins to download.")
download_folder("PhyloP 35-way mm39", url, path)
